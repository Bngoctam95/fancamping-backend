...
export class UploadService {
  ...
  async processAndSaveContentImage(file: Express.Multer.File): Promise<string> {
    try {
      const { dimensions, quality, path: uploadPath } = UPLOAD_CONFIG.content;
      ...
      console.error('Error in processAndSaveContentImage:', error);
      throw new BadRequestException('Failed to process content image');
    }
  }
